...
class UserRegistration(forms.ModelForm):
    password1 = forms.CharField(label='Saisir le Mot de passe', widget=forms.PasswordInput)
    password2 = forms.CharField(
        label='Resaisir le Mot de passe', widget=forms.PasswordInput)
    class Meta:
        ...
        def clean_password2(self):
            ...
            if password1 and password2 and password1 != password2:
                raise forms.ValidationError('Les mots  de passes sont different!!')
            return password2
...
class UserCustomerForm(forms.ModelForm):
    ...
    password2 = forms.CharField(
        label='Resaisir le Mot de password', widget=forms.PasswordInput)
